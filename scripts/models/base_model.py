...
class BaseModel:
    ...
    def to_json(self):
        ...
        # add class name below
        model_dict["__class__"] = type(self).__name__
        for key, value in model_dict.items():
            if isinstance(value, datetime):
                # Here we properly format datetime for created and updated at
        ...
        model_dict["__class__"] = type(self).__name__ checkout update at below
